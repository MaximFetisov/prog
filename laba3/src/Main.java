...
public class Main {
    public static void main(String[] args) {
        try {
            ...
            System.out.println("Малыш тоже долго спал в тот день (Бимбо он взял с собой в постель)" );
            ...
            if (random.nextBoolean()) {
                throw new StoryException("Неожиданное событие в сюжете!");
            }

        } catch (StoryException e) {
            System.out.println("Ошибка сюжета: " + e.getMessage());
        } catch (Exception e) {
